...
class TestDelta
{
    ...
    void testDeltaApis()
    {
        Delta x = new Delta(Delta.Location.AXIS, Delta.Type.ADD, 'foo', null, null, null)
    ...
    void testDeltaClass()
    {
        Delta delta1 = new Delta(Delta.Location.AXIS, Delta.Type.ADD, 'add axis', null, null, null)
        Delta delta2 = new Delta(Delta.Location.AXIS, Delta.Type.DELETE, 'delete axis', null, null, null)
    ...
    {
        Delta delta1 = new Delta(Delta.Location.NCUBE, Delta.Type.UPDATE, 'updated default', null, null, null)
        Delta delta2 = new Delta(Delta.Location.NCUBE_META, Delta.Type.ADD, 'added meta-property', null, null, null)
        Delta delta3 = new Delta(Delta.Location.AXIS, Delta.Type.ADD, 'add axis', null, null, null)
        Delta delta4 = new Delta(Delta.Location.AXIS_META, Delta.Type.UPDATE, 'updated axis meta-prop', null, null, null)
        Delta delta5 = new Delta(Delta.Location.COLUMN, Delta.Type.UPDATE, 'updated column value', null, null, null)
        Delta delta6 = new Delta(Delta.Location.COLUMN_META, Delta.Type.DELETE, 'deleted column meta-prop', null, null, null)
        Delta delta7 = new Delta(Delta.Location.CELL, Delta.Type.ADD, 'added cell', null, null, null)
        Delta delta8 = new Delta(Delta.Location.CELL_META, Delta.Type.DELETE, 'added cell meta-prop', null, null, null)
    ...
    {
        Delta delta1 = new Delta(Delta.Location.NCUBE, Delta.Type.UPDATE, 'alpha', null, null, null)
        Delta delta2 = new Delta(Delta.Location.NCUBE, Delta.Type.UPDATE, 'bravo', null, null, null)
        Delta delta3 = new Delta(Delta.Location.NCUBE, Delta.Type.UPDATE, 'charlie', null, null, null)
    ...
    {
        Delta delta1 = new Delta(Delta.Location.AXIS, Delta.Type.ADD, 'z', null, null, null)
        Delta delta2 = new Delta(Delta.Location.AXIS, Delta.Type.DELETE, 'm', null, null, null)
        Delta delta3 = new Delta(Delta.Location.AXIS, Delta.Type.UPDATE, 'a', null, null, null)
    ...
    {
        Delta empty = new Delta(Delta.Location.COLUMN, Delta.Type.ADD, null, null, null, null)
        assert empty.hashCode() == 0
        assert empty.compareTo(empty) == 0

        Delta delta = new Delta(Delta.Location.COLUMN, Delta.Type.ADD, 'hey', null, null, null)
    ...
    {
        Delta delta = new Delta(Delta.Location.COLUMN, Delta.Type.ADD, 'foo', null, null, null)
