...
class TestNCube extends NCubeBaseTest
{
    ...
    void testPopulateProductLineCube()
    {
        ...
        mutableClient.addCube(commAuto)
    ...
    void testCommandCellLookup()
    {
        ...
        mutableClient.addCube(continentCounty)
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'point2d.json')
    ...
    {
        NCube cube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'latlon.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testCube6.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testCube5.json')
        def coord = [:]
        coord.put("Age", 10)
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testCube3.json')
        def coord = [:]
        coord.put("Code", 1)
        assertTrue("DEF".equals(ncube.getCell(coord)))
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testCube2.json')
        def coord = [:]
        coord.put("Code", 1.0f)
        assertTrue("DEF".equals(ncube.getCell(coord)))
        coord.put("Code", -8.0f)
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testCube1.json')
        def coord = [:]
        Calendar cal = Calendar.instance
        cal.clear()
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, '2DSimpleJson.json')
        def coord = [:]
    ...
    void testStackTrace()
    {
        ...
        mutableClient.addCube(continents)
        mutableClient.addCube(naCountries)
    ...
    {
        NCube n1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template-with-error.json')
    ...
    {
        NCube n1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'updateColumns.json')
    ...
    void testBinaryUrl()
    {
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template1.json')
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template2.json')
        NCube n1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'urlContent.json')
        def coord = [:]
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'simpleJsonArrayTest.json')
        def coord = [:]
        coord.put("Code", "ints")
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'simpleJsonExpression.json')
        Map coord = [:] as Map
        coord.put("code", "exp")
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'nocolumns-nocells-nodefault-error.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'nocolumns-nocells-hasdefault.json')
    ...
    void testIdInCellDoesNotMatch()
    {
        ...
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'id-in-cell-does-not-match-columns-error.json')
    }
    ...
    void testUrlCommandWithoutValueAndUrl()
    {
        // Throws no exception because cell is effectively orphaned.  This test exists so that
        // if we start throwing an exception, this test will need to be updated.
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'url-command-without-value-and-url-error.json')
    }
    ...
    void testAtCommand()
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testAtCommand.json')
    ...
    void testOverlappingRangeCubeError()
    {
        try
        {
            mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'idBasedCubeError.json')
            fail("should not get here")
        }
        catch (AxisOverlapException e)
        {
    ...
    {
        List<NCube> ncubes = mutableClient.getNCubesFromResource(ApplicationID.testAppId, 'testCubeList.json')
    ...
    {
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template2.json')   // Get it loaded
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template1.json')
        def coord = [:]
        coord.put("state", "GA")
        coord.put("code", 1)
    ...
    {
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template2-equivalent.json')   // Get it loaded
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template1.json')
        def coord = [:]
        coord.put("state", "GA")
        coord.put("code", 1)
    ...
    {
        NCube<String> ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'simpleJsonExpression.json')
        def coord = [:]
    ...
    {
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'stringIds.json')
        NCube<String> ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'simpleJsonExpression.json')
        Set<String> scope = ncube.getRequiredScope([:], [:])
        ...
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template2.json')   // Get it loaded
        ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'template1.json')
    ...
    void testStringIds()
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'stringIds.json')
    ...
    {
        NCube<String> ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'updateColumns.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testExpressionAxisUrl.json')
        def coord = [:]
        coord.put("code", "exp")
    ...
    void testNullCube()
    {
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'null-error.json')
    }

    @Test
    void testGroovyMethods()
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testGroovyMethods1.json')
        def coord = [:]
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'expand-url-cube-not-found-error.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'containsCell.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'debugExp.json')
...
//        System.out.println("html = " + html)
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'debugExp2D.json')
        String html = ncube.toHtml()
        assertNotNull(html)
//        System.out.println("html = " + html)
    }
    ...
    {
        mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'sys.classpath.local.resources.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'containsCellNoDefault.json')
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'requiredScopeKeys.json')
        Set<String> scope = ncube.getRequiredScope([:], [:])
    ...
    {
        NCube ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'noRequiredScope.json')
        Set<String> scope = ncube.getRequiredScope([:], [:])
        assertEquals(0, scope.size())
    ...
    void testCubeEquals()
    {
        NCube c1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testCube6.json')
    ...
    {
        NCube c1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'testDuplicate.json')
    ...
    {
        NCube cube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'urlContent.json')
        def coord = [:]
    ...
    {
        NCube cube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'delta.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'delta.json')
    ...
    void testRuleDelta()
    {
        NCube cube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'deltaRule.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'deltaRule.json')
    ...
    {
        NCube cube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'urlPieces.json')
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'debugExp.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'debugExp2D.json')
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, '2DSimpleJson.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'debugExp2D.json')
        assert null == DeltaProcessor.getDelta(cube1, cube2)
    }
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, '2DSimpleJson.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, '2DSimpleJson.json')
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'empty2D.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge1.json')
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge1.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'empty2D.json')
        Map cubeDelta = DeltaProcessor.getDelta(cube1, cube2)
        Map delta = (Map) cubeDelta[DeltaProcessor.DELTA_CELLS]
        assert delta.size() == 5
        DeltaProcessor.mergeDeltaSet(cube1, cubeDelta)
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge1.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge2.json')
    ...
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge2.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge2.json')
        Map coord = [row:3, column:'C'] as Map
        cube1.removeCell(coord);
        Map delta = DeltaProcessor.getDelta(cube1, cube2);
    ...
    void testCellChangeSetCompatibility()
    {
        NCube cube1 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge1.json')
        NCube cube2 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge2.json')
        NCube cube3 = mutableClient.getNCubeFromResource(ApplicationID.testAppId, 'merge3.json')
    ...
    void testPotentialCells()
    {
        ...
        assert 48 == ncube.numPotentialCells

        ncube = NCubeBuilder.discrete1D
        assert 2 == ncube.numPotentialCells

        ncube = NCubeBuilder.testNCube3D_Boolean
        assert 144 == ncube.numPotentialCells

        ncube = NCubeBuilder.trackingTestCube
        assert 4 == ncube.numPotentialCells
    }
    ...
    void testGetCubeSpeed()
    {
        ...
        {
            mutableClient.getCube(ApplicationID.testAppId, ncube.name)
        }
    ...
    {
        NCube<?> ncube = mutableClient.getNCubeFromResource(ApplicationID.testAppId, name)
